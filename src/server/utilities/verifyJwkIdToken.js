...
export async function verifyJwkIdToken(idToken, expectedClientId, idp) {
	...
	// Issuer/audience tarkistukset idp-kohtaisesti
	const issOk =
		(idp === 'google' && (payload.iss === 'https://accounts.google.com' || payload.iss === 'accounts.google.com')) ||
		(idp === 'microsoft' &&
